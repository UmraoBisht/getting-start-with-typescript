...
console.log(processUser({ id: 1, name: 'umrao' }));
// console.log(processUser({name:'umrao'}));
...
console.log(getUsersProperty(users, 'crypto'));
...
const stateObj = new StateObject<(string | number | boolean)[]>([14]);
// stateObj.state = ["2", "3", "5", "67", "8", 4, true]
